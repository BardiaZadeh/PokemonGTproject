...
class MewAttackComparator implements java.util.Comparator<MewSkill> {
    @Override
    public int compare(MewSkill a, MewSkill b) {
        return a.Damage - b.Damage;
    }
}

class MewDefenseComparator implements java.util.Comparator<MewSkill> {
    @Override
    public int compare(MewSkill a, MewSkill b) {
...
public class Mew {
    ...
    protected int _hp;
    protected List<MewSkill> _attackSkills = new ArrayList<>();
    protected List<MewSkill> _defenseSkills = new ArrayList<>();
    private MewSkill lastAction;
    ...
    private void Setup(Integer seed) {
        ...
        _attackSkills.add(new MewSkill() {{
            Damage = 0;
            Name = "Charm";
        }});
        _attackSkills.add(new MewSkill() {{
        ...
        _defenseSkills.add(new MewSkill() {{
            Defense = 1;
            Name = "Endure";
        }});
        _defenseSkills.add(new MewSkill() {{
    ...
    public void battle(Object callingClass, Integer damage)
        ...
        if (_hp > 0) {
            ...
            if (shouldAttack) {
                ...
                Collections.sort(_attackSkills, new MewAttackComparator());
                ...
                Collections.sort(_defenseSkills, new MewDefenseComparator());
