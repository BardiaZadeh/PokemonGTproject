...
class SnorlaxAttackComparator implements java.util.Comparator<SnorlaxSkill> {
    @Override
    public int compare(SnorlaxSkill a, SnorlaxSkill b) {
        return a.Damage - b.Damage;
    }
}

class SnorlaxDefenseComparator implements java.util.Comparator<SnorlaxSkill> {
    @Override
    public int compare(SnorlaxSkill a, SnorlaxSkill b) {
...
public class Snorlax {
    ...
    protected int _hp;
    protected List<SnorlaxSkill> _attackSkills = new ArrayList<>();
    protected List<SnorlaxSkill> _defenseSkills = new ArrayList<>();
    private SnorlaxSkill lastAction;
    ...
    private void Setup(Integer seed) {
        ...
        _attackSkills.add(new SnorlaxSkill() {{
            Damage = 0;
            Name = "Rest";
        }});
        _attackSkills.add(new SnorlaxSkill() {{
        ...
        _defenseSkills.add(new SnorlaxSkill() {{
            Defense = 1;
            Name = "Endure";
        }});
        _defenseSkills.add(new SnorlaxSkill() {{
    ...
    public void battle(Object callingClass, Integer damage)
        ...
        if (_hp > 0) {
            ...
            if (shouldAttack) {
                ...
                Collections.sort(_attackSkills, new SnorlaxAttackComparator());
                ...
                Collections.sort(_defenseSkills, new SnorlaxDefenseComparator());
